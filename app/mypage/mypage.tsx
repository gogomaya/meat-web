...
export const MyPageBanner = () => {
  return (
    <div className="flex justify-center py-8"
      ...
      <h2 className="text-red-100">마이페이지</h2>
      <p>
        <span className="text-white">MyPage</span> / <span style={{color: "#A51C30", textDecoration: "underline"}}>주문 내역</span>
      </p>
    </div>
  )
}
...
export const Side = () => {
  ...
  return (
    <aside id="mypage-sidebar" className="hidden sm:block top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
